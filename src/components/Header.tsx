...
export const Header = () => {
  return (
    <header className=" px-20 pt-10 pb-8 ">
      <div className="flex items-center justify-center mb-10 ">
        ...
        <h2 className="font-semibold ml-2 mr-7 text-[#C92071] text-4xl ">
          Digital Store
        </h2>
        <div className="relative mr-12">
          <input
            className=" px-4 py-4 w-96 bg-slate-100 rounded-lg pl-10"
        ...
        <h4 className=" underline mr-7 text-base font-normal text-gray-400  ">Cadastre-se</h4>
        <button className="px-4 py-2 mr-7 bg-[#C92071] rounded-lg text-white ">Entrar</button>
        <div className="relative">
        <button className="text-[#C92071] text-base h-6 w-6 ">
          <BsCart2 className='w-full h-full ' />
        </button>
        <div className=" w-2 h-2 flex items-center justify-center absolute top-[-5px] right-[-10px] p-2 bg-[#C92071] text-xs text-white rounded-full">
        1
        </div>

        </div>
      </div>
      <ul className="flex gap-8 ml-[5.625rem]">
        <li className=" text-base text-[#C92071] underline ">Home</li>
        <li className="text-gray-400 text-base ">Produtos</li>
        <li className="text-gray-400 text-base ">Categorias</li>
        <li className="text-gray-400 text-base ">Meus Pedidos</li>
      </ul>
    </header>
  );
};
